...
const (
	RaftService_RequestVote_FullMethodName     = "/distributedkv.raft.v1.RaftService/RequestVote"
	RaftService_AppendEntries_FullMethodName   = "/distributedkv.raft.v1.RaftService/AppendEntries"
	RaftService_InstallSnapshot_FullMethodName = "/distributedkv.raft.v1.RaftService/InstallSnapshot"
)
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "distributedkv.raft.v1.RaftService",
	...
	Metadata: "internal/transport/proto/raft.proto",
}
